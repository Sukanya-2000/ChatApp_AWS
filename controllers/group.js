...
exports.createGroup = async (req, res, next) => {
  try {
    ...
    // Finding invited members in the User model
    ...
    // Creating UserGroup entries for each invited member
    (async () => {
      await Promise.all(
      ...
      // Creating a UserGroup entry for the admin
...
exports.addToGroup = async (req, res, next) => {
  try {
    ...
    // Checking if the requester is the admin of the group
    if (group) {
